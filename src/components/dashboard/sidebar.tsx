 ...
 *
 * Per the design spec it pushes the content rather than overlaying it, uses a
 * light-grey ground distinct from the white workspace, and marks the active
 * item with a 4px accent pill on the leading edge.
 */
export function Sidebar({
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-sidebar flex-col border-r border-subtle bg-canvas-inset md:flex">
      {/* Identity */}
      ...
      {/* Primary navigation */}
      <nav aria-label={t("dashboard")} className="flex-1 px-2">
      ...
      {/* Secondary */}
      <div className="space-y-0.5 border-t border-subtle px-2 py-4">
        <Link
